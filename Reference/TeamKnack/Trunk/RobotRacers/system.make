...
# G:\matt\RobotRacer\RobotRacers\system.mhs
# The software specification of the system is in file :
# G:\matt\RobotRacer\RobotRacers\system.mss
...
ECEn490_program: $(ECEN490_OUTPUT) 

$(ECEN490_OUTPUT) : $(ECEN490_SOURCES) $(ECEN490_HEADERS) $(ECEN490_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/ecen490_compiler.opt
	@mkdir -p $(ECEN490_OUTPUT_DIR) 
	$(ECEN490_CC) $(ECEN490_CC_OPT) $(ECEN490_SOURCES) -o $(ECEN490_OUTPUT) \
	$(ECEN490_OTHER_CC_FLAGS) $(ECEN490_INCLUDES) $(ECEN490_LIBPATH) \
	$(ECEN490_CFLAGS) $(ECEN490_LFLAGS) 
	$(ECEN490_CC_SIZE) $(ECEN490_OUTPUT) 

ECEn490_programclean:
	rm -f $(ECEN490_OUTPUT) 
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(ECEN490_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(ECEN490_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)

...
add wave -noupdate -divider {plb_vision Peripheral Interface Signals}
...
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/ipif_IP2Bus_Mst_Length
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/ipif_IP2Bus_Mst_BE
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_Mst_Type
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_MstRd_sof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_MstRd_eof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_MstRd_src_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_MstRd_src_dsc_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_MstRd_dst_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_MstRd_dst_dsc_n
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_MstWr_sof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_MstWr_eof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_MstWr_src_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_IP2Bus_MstWr_src_dsc_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_MstWr_dst_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/ipif_Bus2IP_MstWr_dst_dsc_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rff_RFIFO2IP_WrAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rff_RFIFO2IP_AlmostFull
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rff_RFIFO2IP_Full
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/rff_RFIFO2IP_Vacancy
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/rff_IP2Bus_Data
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rff_IP2Bus_WrAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rff_IP2Bus_RdAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rff_IP2Bus_Error
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_IP2RFIFO_WrReq
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_IP2RFIFO_Data
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_IP2RFIFO_WrMark
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_IP2RFIFO_WrRelease
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_IP2RFIFO_WrRestore
...
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_Mst_Length
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_Mst_Type
...
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_MstRd_rem
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_MstRd_sof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_MstRd_eof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_MstRd_src_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_MstRd_src_dsc_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstRd_dst_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstRd_dst_dsc_n
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstWr_d
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstWr_rem
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstWr_sof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstWr_eof_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstWr_src_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2Bus_MstWr_src_dsc_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_MstWr_dst_rdy_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/Bus2IP_MstWr_dst_dsc_n
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2RFIFO_WrReq
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/IP2RFIFO_Data
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2RFIFO_WrMark
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2RFIFO_WrRelease
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/IP2RFIFO_WrRestore
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/RFIFO2IP_WrAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/RFIFO2IP_AlmostFull
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/RFIFO2IP_Full
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/user_logic_i/RFIFO2IP_Vacancy

add wave -noupdate -divider {User Logic Internal Slave Space Signals}
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg0
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg1
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg2
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg3
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg4
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg5
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg6
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg7
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg8
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg9
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg_write_sel
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg_read_sel
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_ip2bus_data
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/slv_read_ack
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/slv_write_ack

add wave -noupdate -divider {User Logic Internal Master Space Signals}
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_ip2bus_data
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_reg_write_req
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_reg_read_req
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_reg_write_sel
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_reg_read_sel
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_write_ack
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_read_ack
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_reg
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_byte_we
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cntl_rd_req
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cntl_wr_req
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cntl_bus_lock
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cntl_burst
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_ip2bus_addr
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_xfer_length
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_ip2bus_be
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_set_done
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_set_error
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_set_timeout
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_busy
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_clr_go
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_xfer_type
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_xfer_length
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_start_rd_llink
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_cmd_sm_start_wr_llink
add wave -noupdate -format Literal /bfm_system/my_core/my_core/uut/user_logic_i/mst_llrd_sm_state
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_llrd_sm_dst_rdy
add wave -noupdate -format Literal /bfm_system/my_core/my_core/uut/user_logic_i/mst_llwr_sm_state
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_llwr_sm_src_rdy
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_llwr_sm_sof
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_llwr_sm_eof
add wave -noupdate -format Literal -radix decimal /bfm_system/my_core/my_core/uut/user_logic_i/mst_llwr_byte_cnt
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_fifo_valid_write_xfer
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/user_logic_i/mst_fifo_valid_read_xfer

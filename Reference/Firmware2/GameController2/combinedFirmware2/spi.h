//TODO: Modify funcitons to accept u08 slave select data, we have 3 devices on the slave
...
//spiSetCS sets one Chip Select low to enable spi for one device.
//it sets the others high

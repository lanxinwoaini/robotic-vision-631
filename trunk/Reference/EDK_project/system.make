...
# /data/projects/EDK11Trunk/system.mhs
# The software specification of the system is in file :
# /data/projects/EDK11Trunk/system.mss
...
RobotRacers_program: $(ROBOTRACERS_OUTPUT) 

$(ROBOTRACERS_OUTPUT) : $(ROBOTRACERS_SOURCES) $(ROBOTRACERS_HEADERS) $(ROBOTRACERS_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/robotracers_compiler.opt
	@mkdir -p $(ROBOTRACERS_OUTPUT_DIR) 
	$(ROBOTRACERS_CC) $(ROBOTRACERS_CC_OPT) $(ROBOTRACERS_SOURCES) -o $(ROBOTRACERS_OUTPUT) \
	$(ROBOTRACERS_OTHER_CC_FLAGS) $(ROBOTRACERS_INCLUDES) $(ROBOTRACERS_LIBPATH) \
	$(ROBOTRACERS_CFLAGS) $(ROBOTRACERS_LFLAGS) 
	$(ROBOTRACERS_CC_SIZE) $(ROBOTRACERS_OUTPUT) 
	@echo ""

RobotRacers_programclean:
	rm -f $(ROBOTRACERS_OUTPUT) 

#################################################################
# SOFTWARE APPLICATION TESTAPP_SDRAM
#################################################################

TestApp_SDRAM_program: $(TESTAPP_SDRAM_OUTPUT) 

$(TESTAPP_SDRAM_OUTPUT) : $(TESTAPP_SDRAM_SOURCES) $(TESTAPP_SDRAM_HEADERS) $(TESTAPP_SDRAM_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/testapp_sdram_compiler.opt
	@mkdir -p $(TESTAPP_SDRAM_OUTPUT_DIR) 
	$(TESTAPP_SDRAM_CC) $(TESTAPP_SDRAM_CC_OPT) $(TESTAPP_SDRAM_SOURCES) -o $(TESTAPP_SDRAM_OUTPUT) \
	$(TESTAPP_SDRAM_OTHER_CC_FLAGS) $(TESTAPP_SDRAM_INCLUDES) $(TESTAPP_SDRAM_LIBPATH) \
	$(TESTAPP_SDRAM_CFLAGS) $(TESTAPP_SDRAM_LFLAGS) 
	$(TESTAPP_SDRAM_CC_SIZE) $(TESTAPP_SDRAM_OUTPUT) 
	@echo ""

TestApp_SDRAM_programclean:
	rm -f $(TESTAPP_SDRAM_OUTPUT) 
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(ROBOTRACERS_OUTPUT) $(TESTAPP_SDRAM_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(ROBOTRACERS_OUTPUT) $(TESTAPP_SDRAM_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)

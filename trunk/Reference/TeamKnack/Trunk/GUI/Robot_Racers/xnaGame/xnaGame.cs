...
namespace Robot_Racers.XNAGame
{
    class xnaGame : Form
    {
        ...
        public xnaGame()
        {
            ...
            this.xnaDisplay = TheKnack.racer.xnaRoboRacerDisplay1;// new xnaRoboRacerDisplay();
            this.xnaDisplay.fullScreen();
            xnaDisplay.Click -= new System.EventHandler(TheKnack.racer.xnaRoboRacerGame1_Click);//unregister the click handler
            this.Controls.Add(xnaDisplay);
            this.Show();
        ...
        public void CloseGame()
        {
            ...
            TheKnack.racer.tab3DRacer.Controls.Add(xnaDisplay);// this.tab3DRacer.Controls.Add(this.xnaRoboRacerDisplay1);
            xnaDisplay.WindowedScreen(320,240);
            xnaDisplay.Click += new System.EventHandler( TheKnack.racer.xnaRoboRacerGame1_Click);
            this.Dispose();
        }
